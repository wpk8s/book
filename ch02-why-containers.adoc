...
opinions which is the best way.
...
easy horizontal scaling and some extra features that will be discussing
later.

https://bit.ly/3a1DUs2[**Horizontal scaling**] - when our website would face
...
more. So horizontal scaling is the technique through which we multiply
the necessary services without changing configuration and we consume
more and more from the allowed infrastructure, in a manner that is more
accurate and measurable and without facing any downtime, we can as well
decrease, resulting in minimizing the costs, while we continuous serve
...
Major one is that we are truly isolating data between websites, as each
...
Next, we can add additional services to offer higher performance to
...
Another benefit that I really want to point out is easier centralized
...
The most known community is centralizing efforts on
https://bit.ly/3ryhNQ2[Docker Hub], that offers automation for building
...
This is the community I had trust since beginning and never failed for me.

Alternative communities or commercial based image repositories exists,
backed by RedHat, Microsoft's Github and many other, but their usage
goes beyond our purpose, of running WordPress in containers, using one
